 ...
 */
package de.hybris.platform.yacceleratorcore.constants;

/**
 * Global class for all YAcceleratorCore constants. You can add global constants for your extension into this class.
 */
public final class YAcceleratorCoreConstants extends GeneratedYAcceleratorCoreConstants
{
	public static final String EXTENSIONNAME = "yacceleratorcore";


	private YAcceleratorCoreConstants()
	{
		//empty
	}
