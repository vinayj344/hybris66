 ...
 * --- Generated at 26 Mar, 2019 11:53:28 AM                    ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 *  
...
/**
 * Generated class for type <code>YAcceleratorFulfilmentProcessManager</code>.
 */
...
public abstract class GeneratedYAcceleratorFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, YAcceleratorFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, YAcceleratorFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return YAcceleratorFulfilmentProcessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, YAcceleratorFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, YAcceleratorFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, YAcceleratorFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, YAcceleratorFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
