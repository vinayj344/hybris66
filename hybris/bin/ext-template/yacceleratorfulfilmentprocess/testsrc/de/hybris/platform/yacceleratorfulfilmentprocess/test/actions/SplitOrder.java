 ...
 */
package de.hybris.platform.yacceleratorfulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(YAcceleratorFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(YAcceleratorFulfilmentProcessConstants.PARENT_PROCESS);
