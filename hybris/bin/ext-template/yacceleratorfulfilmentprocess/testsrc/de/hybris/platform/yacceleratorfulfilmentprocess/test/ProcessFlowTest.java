...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/yacceleratorfulfilmentprocess/test/yacceleratorfulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/yacceleratorfulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/yacceleratorfulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/yacceleratorfulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/yacceleratorfulfilmentprocess/test/process/consignment-process.xml");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/yacceleratorfulfilmentprocess/test/yacceleratorfulfilmentprocess-spring-testcleanup.xml"));
