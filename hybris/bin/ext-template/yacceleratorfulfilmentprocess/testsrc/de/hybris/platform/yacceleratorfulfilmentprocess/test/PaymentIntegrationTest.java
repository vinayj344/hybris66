...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		definitonFactory.add("classpath:/yacceleratorfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/yacceleratorfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/yacceleratorfulfilmentprocess/test/testCatalog.csv", "windows-1252");
