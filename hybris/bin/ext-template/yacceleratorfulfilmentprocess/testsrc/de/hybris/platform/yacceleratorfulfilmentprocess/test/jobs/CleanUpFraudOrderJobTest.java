 ...
 */
package de.hybris.platform.yacceleratorfulfilmentprocess.test.jobs;
...
import de.hybris.platform.yacceleratorfulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = YAcceleratorFulfilmentProcessConstants.ORDER_PROCESS_NAME;
